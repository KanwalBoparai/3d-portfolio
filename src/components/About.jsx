...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt className='xs:w-[250px] w-full'>
    <motion.div
      ...
      className='w-full bg-tech-gradient p-[1px] rounded-[20px] shadow-tech-card'
    >
      <div
        options={{
          max: 45,
        ...
        className='bg-card-gradient rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col backdrop-blur-sm shadow-lg'
      >
        <img
          src={icon}
          alt='web-development'
        ...
        <h3 className='text-pearl-white text-[20px] font-bold text-center'>
          {title}
        </h3>
      </div>
    </motion.div>
